...
@Table(name = "CERVECERIA_ANTIGUA") // Indica el nombre de la tabla en la base de datos
@Data // Esta anotación de Lombok genera automáticamente getters, setters, toString, equals y hashCode
public class CerveceriaAntigua {
    ...
    // mappedBy indica que el atributo cerveceriaAntigua en la clase Cerveza es el dueño de la relación
    // cascade indica que cuando se elimine una cerveceriaAntigua, se eliminarán todas las cervezas asociadas
    @OneToMany(mappedBy = "cerveceriaAntigua", cascade = CascadeType.ALL)
